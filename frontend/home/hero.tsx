  ...
  return (
    ...
    >
      <div className="bg-[linear-gradient(180deg,rgba(19,19,22,0.97),rgba(9,9,10,0.99)),rgba(11,11,12,0.94)] border border-line shadow-[0_30px_80px_var(--shadow),inset_0_1px_0_rgba(255,255,255,0.04)] relative before:absolute before:inset-0 before:pointer-events-none before:bg-[linear-gradient(rgba(255,255,255,0.06)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.06)_1px,transparent_1px)] before:bg-size-[62px_62px] before:opacity-[0.36] overflow-hidden rounded-[2.4rem] px-6 py-8 sm:px-8 lg:px-10">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_8%,rgba(255,115,0,0.18),transparent_26%),radial-gradient(circle_at_82%_86%,rgba(255,94,0,0.2),transparent_24%),linear-gradient(180deg,rgba(255,150,40,0.04),transparent_24%,transparent_76%,rgba(255,95,0,0.04))]" />
        <div className="pointer-events-none absolute bottom-[34%] left-[-4%] top-0 w-[36%] opacity-[0.82] blur-[14px] bg-[linear-gradient(180deg,rgba(255,140,24,0.14),transparent_72%),repeating-linear-gradient(90deg,rgba(255,113,20,0.8)_0_18px,rgba(255,113,20,0.06)_18px_46px)] mask-[linear-gradient(180deg,rgba(0,0,0,0.95),rgba(0,0,0,0.18)_72%,transparent)]" />
        <div className="pointer-events-none absolute bottom-[-10%] right-[-3%] top-[28%] w-[36%] opacity-[0.82] blur-[14px] bg-[linear-gradient(0deg,rgba(255,140,24,0.18),transparent_78%),repeating-linear-gradient(90deg,rgba(255,113,20,0.86)_0_18px,rgba(255,113,20,0.06)_18px_46px)] mask-[linear-gradient(0deg,rgba(0,0,0,0.96),rgba(0,0,0,0.2)_68%,transparent)]" />
        <div className="overflow-hidden border border-[rgba(255,255,255,0.08)] bg-[radial-gradient(circle_at_center,rgba(242,92,22,0.18),transparent_62%),radial-gradient(rgba(255,255,255,0.14)_1px,transparent_1px)] bg-size-[auto,12px_12px] shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] before:absolute before:inset-0 before:bg-[linear-gradient(180deg,rgba(255,255,255,0.04),transparent),radial-gradient(circle_at_30%_30%,rgba(255,255,255,0.12),transparent_34%)] before:content-[''] absolute bottom-[18%] right-[12%] hidden h-24 w-24 rounded-[1.25rem] lg:block" />
